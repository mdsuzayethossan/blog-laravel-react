    ...
    return (
        <div className="rounded">
            <img
                ...
                src="https://i.ibb.co/ZNpjV8G/image-24.png"
                alt=""
            />
            <div className="px-10 py-7">
                <div className="bg-[#8bc43f] rounded flex pl-12 py-3 gap-7 text-white">
                    <div className="flex border-r-2 pr-7">
                        <svg
                ...
                <h3 className="font-semibold text-3xl my-7">
